...
public class SimulateClass {
    ...
    private static String getLongestString(String... longestStringArray) {     // VarArgs example
        int maxLenght = 0;
        String auxString = "";
    ...
    public static void main(String[] args) {
        ...
        for (Group element : getAllGroupsWithMaxNumOfStudent(groups)) {
...
//
//        printStudentsAlphabeticallyByFirstName();
        System.out.println("Triplul: " + tripleNumberOfStudentsFromMaxGroup(getAllGroupsWithMaxNumOfStudent(groups)));
    }
...
//                .forEach(student -> System.out.print(student+ " "));
    ...
    public static List<Group> getAllGroupsWithMaxNumOfStudent(List<Group> groupList) {
