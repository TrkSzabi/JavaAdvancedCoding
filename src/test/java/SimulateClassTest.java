...
public class SimulateClassTest {
    ...
    @Test
    void getAllGroupsWithMaxNumOfStuden() {
        //Given
        List<Group> groups = new ArrayList<>();
        Student student1 = new Student("Student01", "CAlexandru", LocalDate.of(1998, Month.OCTOBER, 12), true);
        Student student2 = new Student("Student01", "CAlexandru", LocalDate.of(1998, Month.OCTOBER, 12), true);
        ...
        //Then
        assertEquals(2,SimulateClass.getAllGroupsWithMaxNumOfStudent(groups).size());
